      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            {/* Business Hours & WhatsApp Button */}
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              {/* Business Hours */}
              <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 border border-gray-100 hover:shadow-2xl transition-all duration-300 opacity-0 animate-slide-right delay-600">
                <div className="flex items-center gap-4">
              ...
              <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 border border-gray-100 hover:shadow-2xl transition-all duration-300 opacity-0 animate-slide-right delay-700">
                <button
                  onClick={() => {
                    const phoneNumber = '+966500081927';
                    const message = t('contact.whatsappButton.message');
                    const url = `https://wa.me/${phoneNumber.replace(/[^0-9]/g, '')}?text=${encodeURIComponent(message)}`;
                    window.open(url, '_blank');
                  }}
                  className="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300 hover:shadow-lg hover:scale-105 flex items-center justify-center gap-3 group"
                >
                  <svg 
                    width="24" 
                    height="24" 
                  ...
                  <span className="text-lg">{t('contact.whatsappButton.text')}</span>
                </button>
              </div>
            </div>

            {/* Quick Stats */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 opacity-0 animate-slide-right delay-800">
              ...
              <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl p-4 text-white text-center">
                ...
                <div className="text-sm opacity-90">دعم فني</div>
              </div>
            </div>
          </div>
